/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/exa-gatekeeper/wrangler.jsonc packages/exa-gatekeeper/worker-configuration.d.ts` (hash: 2118672e85a5a9b3dc89d6bbc3b77f24)
